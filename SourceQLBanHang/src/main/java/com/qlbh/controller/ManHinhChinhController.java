...
public class ManHinhChinhController {
	...
	/**
	 * Sử dụng để lưu giá trị Index của tab Khách hàng khi đã được thêm vào
	 * trong tabPane. Nếu giá trị của nó là -1 thì nó chưa được thêm vào
	 * tabPane. Nếu giá trị khác -1 thì đó là Index của tabKhachHang.
	 */
	...
	void onButtonKhachHangClick(ActionEvent event) {
		...
		// Kiểm tra xem tab Khách hàng đã đc thêm vào hay chưa, nếu đã thêm thì
		// thoát
